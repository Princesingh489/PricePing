...
class PlaywrightPool:
    ...
    async def _get_browser(cls):
        """Get or lazily launch the persistent shared Chromium browser."""
        ...
        async with cls._lock:
            ...
            logger.info("Initializing warm Playwright Chromium browser instance...")
    ...
    async def fetch_html(
        ...
        """
        Fetches the rendered HTML using warm Playwright Chromium with stealth context.
        Reuses browser instance and only creates/closes a lightweight browser context.
        """
        context = None
        try:
